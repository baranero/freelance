...
const Work = () => {
  ...
  return (
    <div className="bg-primary/30 h-full lg:h-[100vh] xl:h-[100vh] pt-24 lg:flex xl:flex justify-center lg:items-center xl:items-center overflow-y-scroll xl:overflow-hidden">
